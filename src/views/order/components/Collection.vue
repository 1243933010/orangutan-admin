            ...
            <div class="content">
                ...
                <div class="form">
                    ...
                    <div class="flex-row">
                        ...
                        <!-- <el-badge :value="3"> -->
                        <div class="form-items">
                            <div class="form-item-title">聊天记录</div>
                    ...
                    <div class="flex-row">
                        <div class="form-items" style="width:50%;">
                            ...
                            <div class="form-item-title form-item-see" @click="seeImg(orderDetail.dealer_refund_images)">
                                查看附件
                            </div>
...
import { order_detail, order_received, order_received_argue, } from '@/api/project'
