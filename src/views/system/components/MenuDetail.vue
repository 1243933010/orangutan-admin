                        ...
                        <el-form-item label="父级菜单" prop="name">
                            <el-col :span="12">
                                <el-select v-model="formData.parent_id" placeholder="请选择">
                                    ...
                                    <el-option  v-for="(item,index) in list" :key="index" :label="item.name" :value="item.menu_id"> </el-option>
                                </el-select>
                            </el-col>
                        </el-form-item>
                        <el-form-item label="关联权限" prop="name">
                            <el-col :span="12">
                                <el-select v-model="formData.permission_id" placeholder="请选择">
                                    <el-option  label="首级" :value="0"> </el-option>
                                    <el-option v-for="(item,index) in permissionsList" :key="index" :label="item.display_name" :value="item.permission_id"> </el-option>
                                </el-select>
                            </el-col>
                        </el-form-item>
                        <el-form-item label="菜单名称" prop="name">
                            <el-col :span="12">
                                <el-input v-model="formData.name" placeholder="菜单名称"></el-input>
                            </el-col>
                        </el-form-item>
                        <el-form-item label="菜单路径" prop="path">
                            <el-col :span="12">
                                <el-input v-model="formData.path" placeholder="菜单路径"></el-input>
                            </el-col>
                        </el-form-item>
                        <el-form-item label="附加字段" prop="additional">
                            <el-col :span="12">
                                <el-input v-model="formData.additional" placeholder="附加字段"></el-input>
                            </el-col>
                        </el-form-item>
...
export default {
    ...
    methods: {
       async getPermissionsList(){
        ...
        async getDetail(id) {
            let res = await menus_detail(id)
            if (res.code == 200) {
                this.formData = res.data;
            }
        },
        async getList() {
            let res = await menus_list(this.formData)
            if (res.code == 200) {
